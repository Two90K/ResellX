...
if LPH_OBFUSCATED == nil then
    ...
    LRM_ScriptName = "ResellX"
    LRM_TotalExecutions = 0
    LRM_SecondsLeft = math.huge
    LRM_UserNote = "Developer";
end;

local Game_Name = (game.PlaceId == 4991214437 and "Town") or (game.PlaceId == 18642421777 and "The ResellX") or (game.PlaceId == 16472538603 and "The ResellX") or (game.PlaceId == 13643807539 and "South ResellX") or (game.PlaceId == 93612682780562 and "South ResellX") or (game.PlaceId == 14413475235 and "South ResellX") or (game.PlaceId == 104715542330896 and "BlockSpin") or (game.PlaceId == 71600459831333 and "Street Life") or "Universal" or game.PlaceId == 13643807539
...
local Services = setmetatable({}, {
    __index = LPH_NO_VIRTUALIZE(function(self, service, key)
        if Solara and (service == "VirtualInputManager") and (Game_Name == "The ResellX") then
...
if Game_Name == "South ResellX" and not Solara then
...
if script_key then
    writefile("ResellX_Key.txt", script_key)
end
...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.LocalPlayer:Kick("ResellX | Security : You are running another script, please disable it and execute again")
    end
end
...
local Config = {
    ...
    ["Game"] = {
        ["Ray_Systems"] = (Game_Name == "Road To Riches" and {"Raycast"} or Game_Name == "BlockSpin" and {"Raycast"} or Game_Name == "Town" and {"Raycast"} or Game_Name == "Universal" and {"Raycast","FindPartOnRay","FindPartOnRayWithWhitelist"} or Game_Name == "The ResellX" and {"FindPartOnRay"}  or Game_Name == "South ResellX" and {"Raycast"} or Game_Name == "Street Life" and {"Raycast"} or Game_Name == "Criminality" and {"Raycast"}) or {};
        ["Wall_Bang_Possible"] = ((Game_Name == "Universal" or Game_Name == "Criminality" or Game_Name == "South ResellX" or Game_Name == "The ResellX" or Game_Name == "Street Life"));
    };
    ...
    ESP = {
        ...
        Options = { 
            Teamcheck = true, TeamcheckRGB = Color3.fromRGB(255, 100, 0),
            Friendcheck = true, FriendcheckRGB = Color3.fromRGB(255, 100, 0),
            Highlight = false, HighlightRGB = Color3.fromRGB(255, 100, 0),
        },
        Drawing = {
            Chams = {
                Enabled  = false,
                Thermal = true,
                FillRGB = Color3.fromRGB(255, 100, 0),
                Fill_Transparency = 80,
                OutlineRGB = Color3.fromRGB(255, 100, 0),
            ...
            Weapons = {
                Enabled = false, WeaponTextRGB = Color3.fromRGB(255, 100, 0),
                Outlined = false,
                Gradient = false,
                Transparency = 0,
                GradientRGB1 = Color3.fromRGB(255, 100, 0), GradientRGB2 = Color3.fromRGB(255, 100, 0),
            },
            Inventory = {
                Enabled = false, RGB = Color3.fromRGB(255, 100, 0),
                Transparency = 0,
            },
            Healthbar = {
                Enabled = false,  
                HealthText = false, Lerp = true, HealthTextRGB = Color3.fromRGB(255, 100, 0),
                Width = 2.5,
                Transparency = 0,
                HealthTextTransparency = 0,
                Gradient = true, GradientRGB1 = Color3.fromRGB(255, 100, 0), GradientRGB2 = Color3.fromRGB(255, 100, 0)
            },
            Boxes = {
                Animate = true,
                RotationSpeed = 300,
                Gradient = false, GradientRGB1 = Color3.fromRGB(255, 100, 0), GradientRGB2 = Color3.fromRGB(255, 100, 0), 
                GradientFill = true, GradientFillRGB1 = Color3.fromRGB(255, 100, 0), GradientFillRGB2 = Color3.fromRGB(255, 100, 0), 
                Filled = {
                    Enabled = false,
                    Transparency = 0.75,
                    RGB = Color3.fromRGB(255, 100, 0),
...
--[[if not Solara and Game_Name == "The ResellX" then
    local DTC;
...
if not Solara then
    ...
    if Game_Name == "Universal" or Game_Name == "Road To Riches" or Game_Name == "Street Life" or Game_Name == "The ResellX" or Game_Name == "Town" and not Solara then
        local DTC;
    ...
    LPH_JIT_MAX(function()
        ...
        if Game_Name == "The ResellX" then
            RunService:BindToRenderStep("MiscSettings", 1000 , LPH_NO_VIRTUALIZE(function(Delta)
                ...
                if not (Game_Name == "South ResellX") and not (Game_Name == "Road To Riches") then
            ...
            RunService:BindToRenderStep("MiscSettings", 1000 , LPH_NO_VIRTUALIZE(function()
                ...
                if Game_Name == "South ResellX" then
                ...
                if Game_Name == "South ResellX" and Solara then
                    return
                end

                if Game_Name == "South ResellX" and Config.South_Bronx.LocalPlayer_Config.InfiniteStamina and not Solara then
        ...
        GetClosestPlayerToMouseAimbot = LPH_NO_VIRTUALIZE(function()
            ...
            if library.priority[1] then
                for Index, Value in Plrs do
                    ...
                    if (Value.Character and Value.Character:FindFirstChild(Config.Aimlock.TargetPart) and Value.Character:FindFirstChild("Humanoid") and Value.Character:FindFirstChild("Humanoid").Health > (Game_Name == "South ResellX" and 4 or 0)) then
        ...
        GetClosestPlayerToMouseSilent = LPH_NO_VIRTUALIZE(function()
            ...
            if library.priority[1] then
                for Index, Value in Plrs do
                    ...
                    if not table.find(library.priority, Value.Name) then continue end;
                    if table.find(library.whitelist, Value.Name) then continue end;
                    if (Value.Character and FindFirstChild(Value.Character, "HumanoidRootPart") and FindFirstChild(Value.Character,"Humanoid") and FindFirstChild(Value.Character,"Humanoid").Health > (Game_Name == "South ResellX" and 4 or 0)) then
                        if FindFirstChildOfClass(Value.Character, "ForceField") then continue end
                        if FindFirstChild(Value.Character, "Torso") and FindFirstChild(Value.Character, "Torso").Material == Enum.Material.ForceField then continue end
                        if Value.Character.Parent == nil then continue end
            ...
            if Method == "Raycast" and table.find(Config.Game.Ray_Systems, "Raycast") then
                ...
                if Config.Silent.Enabled then
                    if Config.Silent.Targetting then
                        ...
                        if not Config.Silent.WallBang and Game_Name == "South ResellX" then
                            local RaycastParams = RaycastParams.new()
        ...
        for Index, Value in Players:GetPlayers() do
            if Value == LocalPlayer then continue end;
            if Game_Name == "South ResellX" then continue end
        ...
        Players.PlayerAdded:Connect(function(Value)
            if Game_Name == "South ResellX" then return end
        ...
        if Game_Name == "South ResellX" then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                textLabel.Text = '<font color="rgb(0,163,224)">ResellX.</font>lol\n' .. Title
        ...
        if Game_Name == "The ResellX" and RequireSupport then                                                
            local OldWeaponValues = {}
...
do
    ...
    do -- Initalize
        ...
        local ESP = function(plr)
            ...
            local Name = Functions:Create("TextLabel", {Visible = false,Parent = ScreenGui, Position = UDim2.new(0.5, 0, 0, -11), Size = UDim2.new(0, 100, 0, 20), AnchorPoint = Vector2.new(0.5, 0.5), BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(255, 100, 0), Font = Enum.Font.Code, TextSize = Config.ESP.FontSize, TextStrokeTransparency = 0, TextStrokeColor3 = Color3.fromRGB(255, 100, 0), RichText = true})
            local Distance = Functions:Create("TextLabel", {Visible = false,Parent = ScreenGui, Position = UDim2.new(0.5, 0, 0, 11), Size = UDim2.new(0, 100, 0, 20), AnchorPoint = Vector2.new(0.5, 0.5), BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(255, 100, 0), Font = Enum.Font.Code, TextSize = Config.ESP.FontSize, TextStrokeTransparency = 0, TextStrokeColor3 = Color3.fromRGB(255, 100, 0), RichText = true})
            local Weapon = Functions:Create("TextLabel", {Visible = false,Parent = ScreenGui, Position = UDim2.new(0.5, 0, 0, 31), Size = UDim2.new(0, 100, 0, 20), AnchorPoint = Vector2.new(0.5, 0.5), BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(255, 100, 0), Font = Enum.Font.Code, TextSize = Config.ESP.FontSize, TextStrokeTransparency = 0, TextStrokeColor3 = Color3.fromRGB(255, 100, 0), RichText = true, Text = "None"})
            local Box = Functions:Create("Frame", {Parent = ScreenGui, BackgroundColor3 = Color3.fromRGB(255, 100, 0), BackgroundTransparency = 0.75, BorderSizePixel = 0})
            ...
            local Outline = Functions:Create("UIStroke", {Parent = Box, Enabled = Config.ESP.Drawing.Boxes.Gradient, Transparency = 0, Color = Color3.fromRGB(255, 100, 0), LineJoinMode = Enum.LineJoinMode.Miter})
            ...
            local Healthbar = Functions:Create("Frame", {Parent = ScreenGui, BackgroundColor3 = Color3.fromRGB(255, 100, 0), BackgroundTransparency = 0})
            local BehindHealthbar = Functions:Create("Frame", {BorderColor3 = Color3.fromRGB(255, 100, 0), Parent = ScreenGui, ZIndex = -1, BackgroundColor3 = Color3.fromRGB(255, 100, 0), BackgroundTransparency = 0})
            ...
            local HealthText = Functions:Create("TextLabel", {Visible = false,Parent = ScreenGui, Position = UDim2.new(0.5, 0, 0, 31), Size = UDim2.new(0, 100, 0, 20), AnchorPoint = Vector2.new(0.5, 0.5), BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(255, 100, 0), Font = Enum.Font.Code, TextSize = Config.ESP.FontSize, TextStrokeTransparency = 0, TextStrokeColor3 = Color3.fromRGB(255, 100, 0), ZIndex = 500})
            local Chams = Functions:Create("Highlight", {Parent = ScreenGui, FillTransparency = 1, OutlineTransparency = 0, OutlineColor = Color3.fromRGB(255, 100, 0), DepthMode = "AlwaysOnTop"})
            local WeaponIcon = Functions:Create("ImageLabel", {Parent = ScreenGui, BackgroundTransparency = 1, BorderColor3 = Color3.fromRGB(255, 100, 0), BorderSizePixel = 0, Size = UDim2.new(0, 40, 0, 40)})
            ...
            local Flag1 = Functions:Create("TextLabel", {Visible = false,Parent = ScreenGui, Position = UDim2.new(1, 0, 0, 0), Size = UDim2.new(0, 100, 0, 20), AnchorPoint = Vector2.new(0.5, 0.5), BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(255, 100, 0), Font = Enum.Font.Code, TextSize = Config.ESP.FontSize, TextStrokeTransparency = 0, TextStrokeColor3 = Color3.fromRGB(255, 100, 0)})
            local Flag2 = Functions:Create("TextLabel", {Visible = false,Parent = ScreenGui, Position = UDim2.new(1, 0, 0, 0), Size = UDim2.new(0, 100, 0, 20), AnchorPoint = Vector2.new(0.5, 0.5), BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(255, 100, 0), Font = Enum.Font.Code, TextSize = Config.ESP.FontSize, TextStrokeTransparency = 0, TextStrokeColor3 = Color3.fromRGB(255, 100, 0)})
            --local DroppedItems = Functions:Create("TextLabel", {Visible = false,Parent = ScreenGui, AnchorPoint = Vector2.new(0.5, 0.5), BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(255, 100, 0), Font = Enum.Font.Code, TextSize = Config.ESP.FontSize, TextStrokeTransparency = 0, TextStrokeColor3 = Color3.fromRGB(255, 100, 0)})
            --
                    ...
                    task.spawn(LPH_NO_VIRTUALIZE(function()
                        ...
                        do -- \\ Boxes
                            ...
                            if Config.ESP.Drawing.Boxes.Filled.Enabled then
                                Box.BackgroundColor3 = Color3.fromRGB(255, 100, 0)
...
local window = library:window({name = "ResellX", suffix = "", gameInfo = string.format("ResellX : %s", Game_Name:lower())})
    ...
    window:seperator({name = "Game"}) do
        local LocalPlayerTab, PlayersTab, PurchaseGunTab, MiscTab, SafeTab = window:tab({name = "Main", tabs = {"Local Player", "Players", "Teleports", "Misc", "Safe"}, icon = GetImage("World.png")}) do
            ...
            do -- \\ Local Player Tab
                ...
                local _UINames, BlacklistedNames = {'ATM GUI'}, {"Dead", "Settings1", "Controls", "FirstShopGUI", "Freecam", "ThaShop2", "WATCH GUI", "NYPD Cars", "CONSTRUCTION LEVEL", "RobPlayerUI", "ResellX LOCKER", 'MobileBeam', 'Settings', 'Flash', 'Enter', 'CopSirens'}
                ...
                UISection:dropdown({name = "Selected UI", flag = "SelectedUI_TB3", width = 120, items = _UINames, seperator = false, multi = false, default = 'ResellX Market 2'})
            ...
            do -- \\ Misc Tab
                ...
                ManualFarmSections:button({name = "Clean All Filthy Money", callback = LPH_NO_VIRTUALIZE(function()
                    ...
                    repeat task.wait() until Cleaner:FindFirstChild("On", true).Color == Color3.fromRGB(255, 100, 0)
...
window:seperator({name = "Combat"}) do
    local SilentAimTab = window:tab({name = "Silent Aim", tabs = {"General Settings"}, icon = GetImage("Pistol.png")}) do
        ...
        SettingsSection:slider({name = "Max Distance", flag = "MaxDistance_Silent", min = 0, max = (Game_Name == "South ResellX") and 300 or 3000, default = (Game_Name == "South ResellX") and 300 or 1000, suffix = "st", callback = function(state)
    ...
    local AimlockTab = window:tab({name = "Aimlock", tabs = {"General Settings"}, icon = GetImage("Aimlock.png")}) do
        ...
        SettingsSection:slider({name = "Max Distance", flag = "MaxDistance_Aimlock", min = 0, max = 3000, default = ((Game_Name == "South ResellX") and 300 or 1000), suffix = "st", callback = function(state)
    ...
    if Game_Name == "The ResellX" and not Solara then
...
window:seperator({name = "World"}) do
    ...
    _FilledBoxes:colorpicker({flag = "PlayerVisuals_FilledBoxes_Color1", color = Color3.fromRGB(255, 100, 0), alpha = 0.25, callback = function(state, alpha)
        Config.ESP.Drawing.Boxes.GradientFillRGB1 = state
        Config.ESP.Drawing.Boxes.Filled.Transparency = alpha
        RefreshAllElements()
    end})

    _FilledBoxes:colorpicker({flag = "PlayerVisuals_FilledBoxes_Color2", color = Color3.fromRGB(255, 100, 0), alpha = 1, callback = function(state, alpha)
    ...
    _ChamsToggle:colorpicker({flag = "PlayerVisuals_Chams_Color1", color = Color3.fromRGB(255, 100, 0), alpha = 0.8, callback = function(state, alpha)
...
if hookfunction and not Solara and LPH_OBFUSCATED and Game_Name == "South ResellX" then
    local _FireServer;
    local _Function;
